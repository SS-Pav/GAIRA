...
OUTPUT_DIR="${OUTPUT_DIR:-/home/suraj/projects/GAIRA/data/processed/embedding_v8_small2023_branch_gpu_run1}"
REPORT_DIR="${REPORT_DIR:-/home/suraj/projects/GAIRA/data/processed/embedding_v8_small2023_branch_gpu_run1_eval_v2}"
EPOCHS="${EPOCHS:-30}"
