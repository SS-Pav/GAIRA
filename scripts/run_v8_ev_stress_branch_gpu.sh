...
OUTPUT_DIR="${OUTPUT_DIR:-/home/suraj/projects/GAIRA/data/processed/embedding_v8_ev_stress_branch_gpu_run1}"
REPORT_DIR="${REPORT_DIR:-/home/suraj/projects/GAIRA/data/processed/embedding_v8_ev_stress_branch_gpu_run1_eval_v2}"
EPOCHS="${EPOCHS:-40}"
...
python scripts/train_embedding_model.py \
  ...
  --branch-mode ev_stress \
  --preset pass8_ev_stress_branch \
