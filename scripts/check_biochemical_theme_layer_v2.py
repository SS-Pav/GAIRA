...
def main() -> None:
    ...
    base_dir = storage_paths["processed_data"] / "biochemical_theme_layer_v2"
    ...
    report_md = base_dir / "report" / "biochemical_theme_layer_v2_report.md"
    report_pdf = base_dir / "report" / "biochemical_theme_layer_v2_report.pdf"
