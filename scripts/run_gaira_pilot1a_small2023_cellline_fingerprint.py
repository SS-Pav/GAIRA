...
from gaira.demo.gaira_pilot_utils import (
    ...
    build_fingerprint_markdown_report,
    build_pdf_report,
...
SPRINT_SUBDIR = "pilot1a_small2023_cellline_fingerprint"
...
def main() -> None:
    ...
    plot_bsv_heatmap(
        ...
        "small2023_cellline Class Mean BSV",
    )
    plot_pairwise_delta_heatmap(
        pairwise_delta_df,
    ...
    for class_label in sorted(class_mean_bsv_df["class_label"].astype(str).unique().tolist()):
        plot_radar_for_class(
            class_mean_bsv_df,
            class_label,
    ...
    report_md = build_fingerprint_markdown_report(
        sprint_paths,
        subset_alias=resolved.subset_alias,
    ...
    build_pdf_report(
        report_md,
        figure_paths,
        sprint_paths.report_dir / "GAIRAv3_Pilot1a_small2023_cellline_fingerprint_report.pdf",
    )
    print(f"Wrote Pilot 1a fingerprint outputs under {sprint_paths.sprint_root}")
