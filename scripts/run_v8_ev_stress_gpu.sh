...
OUTPUT_DIR="${OUTPUT_DIR:-/home/suraj/projects/GAIRA/data/processed/embedding_v8_ev_stress_gpu_run1}"
REPORT_DIR="${REPORT_DIR:-/home/suraj/projects/GAIRA/data/processed/embedding_v8_ev_stress_gpu_run1_eval_v2}"
...
echo "Running v8 EV stress GPU branch"
