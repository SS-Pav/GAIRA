# proline · Representation-hierarchy assessment (V3)
*Family: amino_acid · expected theme: aromatic_amino_acid|protein_peptide*

| Layer | Metric | Value |
|---|---|---|
| 1 · Latent fingerprint | component cosine | 0.31 |
| 2 · MSS motif | mss cosine | 0.8426 |
| 3 · Theme (raw) | theme cosine raw | 0.8689 |
| 3 · Theme (identity) | baseline-subtracted | -0.733 (null -0.6408, sep -0.0922) |
| 4 · Theme rank | Spearman ρ | 0.9091 (sep 0.0153) |
| 5 · Top-k overlap | top-2 / top-3 | 1.0 / 0.667 |
| 6 · Argmax agreement | dominant theme | saccharide_glycan → nucleic_purine (differ) |
| 7 · Family | ΔPurine share | 0.0996 (0.1109 → 0.2104) |
...
## Layer 9 — Limitations
- Raw theme cosine and raw rank ρ are baseline-inflated and are NOT stand-alone evidence; this analyte's identity-specific signal is cosine -0.73 / rank separation +0.015.
