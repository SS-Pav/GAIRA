# hydroxyproline · Representation-hierarchy assessment (V3)
*Family: amino_acid · expected theme: aromatic_amino_acid|protein_peptide*

| Layer | Metric | Value |
|---|---|---|
| 1 · Latent fingerprint | component cosine | 0.241 |
| 2 · MSS motif | mss cosine | 0.6319 |
| 3 · Theme (raw) | theme cosine raw | 0.8238 |
| 3 · Theme (identity) | baseline-subtracted | -0.5354 (null -0.5228, sep -0.0126) |
| 4 · Theme rank | Spearman ρ | 0.8273 (sep 0.0244) |
| 5 · Top-k overlap | top-2 / top-3 | 0.5 / 0.333 |
| 6 · Argmax agreement | dominant theme | saccharide_glycan → nucleic_purine (differ) |
| 7 · Family | ΔPurine share | 0.1117 (0.0918 → 0.2035) |
...
## Layer 9 — Limitations
- Raw theme cosine and raw rank ρ are baseline-inflated and are NOT stand-alone evidence; this analyte's identity-specific signal is cosine -0.54 / rank separation +0.024.
