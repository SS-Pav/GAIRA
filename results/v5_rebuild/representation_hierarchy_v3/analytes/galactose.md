# galactose · Representation-hierarchy assessment (V3)
*Family: saccharide · expected theme: saccharide_glycan*

| Layer | Metric | Value |
|---|---|---|
| 1 · Latent fingerprint | component cosine | 0.4462 |
| 2 · MSS motif | mss cosine | 0.7966 |
| 3 · Theme (raw) | theme cosine raw | 0.9241 |
| 3 · Theme (identity) | baseline-subtracted | -0.2446 (null -0.3684, sep 0.1237) |
| 4 · Theme rank | Spearman ρ | 0.9364 (sep 0.002) |
| 5 · Top-k overlap | top-2 / top-3 | 1.0 / 1.0 |
| 6 · Argmax agreement | dominant theme | saccharide_glycan → nucleic_purine (differ) |
| 7 · Family | ΔPurine share | 0.0381 (0.169 → 0.2071) |
...
## Layer 9 — Limitations
- Raw theme cosine and raw rank ρ are baseline-inflated and are NOT stand-alone evidence; this analyte's identity-specific signal is cosine -0.24 / rank separation +0.002.
