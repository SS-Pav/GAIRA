...
Two identities, two names. **Never call both "the atlas fingerprint".**

| term | value | identifies |
|---|---|---|
| **Scientific Atlas Fingerprint** | `09ed804a40836f4a05a91ba10900cded` | the scientific atlas identity generated by the Phase 01 build |
| **Frozen Runtime Content Hash** | `2e43ddcca7d3be41c5f9da016fb8277f` | the complete frozen runtime asset identity |

The three remaining declared fingerprints identify individual frozen artefacts:
