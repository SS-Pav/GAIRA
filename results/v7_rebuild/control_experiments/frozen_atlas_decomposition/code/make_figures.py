...
own. Deterministic: no RNG, no timestamps.
    ...
    python results/v7_rebuild/control_experiments/frozen_atlas_decomposition/code/make_figures.py
"""
...
from gaira.v7.atlas_decomposition import visualization as VZ           # noqa: E402

T, F, A = CTRL / "tables", CTRL / "figures", CTRL / "artifacts"
...
def f09():
    ...
    ax.text(2, 67.5, f"{len(kept)} retained Atlas Component Substructures "
