"""GAIRA V7 — deterministic Local Spectral Motif discovery.
...
diagnostic bands, and clusters those profiles. Each cluster is a Local Spectral Motif: a
...
from .motif import LSM, Band, build_motif_spectrum

DISCOVERY_VERSION = "v7_lsm_v1"
...
def _score_redundancy(motifs: list[LSM]) -> None:
...
def _reject(motifs: list[LSM]) -> None:
