...
THEME_ONTOLOGY: dict[str, ThemeDefinition] = {
    "lipid_membrane_associated": ThemeDefinition(
        ...
        anchor_bands_cm=(718.0, 1058.0, 1060.0, 1270.0, 1295.0, 1300.0, 1445.0, 1460.0, 1655.0),
        negative_keywords=(
            "amide",
            "protein",
            "peptide",
    ...
    "protein_peptide_associated": ThemeDefinition(
        ...
        anchor_bands_cm=(725.0, 1003.0, 1240.0, 1250.0, 1256.0, 1263.0, 1450.0, 1525.0, 1576.0, 1602.0, 1660.0),
        negative_keywords=(
            "lipid",
            "membrane",
            "phospholipid",
    ...
    "nucleic_acid_purine_associated": ThemeDefinition(
        ...
        anchor_bands_cm=(725.0, 733.0, 782.0, 797.0, 960.0, 1337.0, 1482.0, 1485.0, 1525.0, 1578.0, 1602.0),
        negative_keywords=(
            "amide",
            "protein",
            "peptide",
    ...
    "oxidative_metabolic_stress_associated": ThemeDefinition(
        ...
        anchor_bands_cm=(725.0, 733.0, 739.0, 960.0, 1003.0, 1200.0, 1250.0, 1270.0, 1300.0, 1525.0, 1576.0, 1602.0, 1655.0),
        negative_keywords=(
            "structural membrane",
            "stable phospholipid",
            "collagen",
